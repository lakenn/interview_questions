...
class UnifiedDataAPI:
    ...
    def __init__(self, symbols: [str], start_time: TimeStamp):
        ...
        self.live_data_source = LiveDataSource(CURRENT_TIME - pd.Timedelta('1D'))
    ...
    def get_next_data_point(self) -> tuple[TimeStamp, pd.Series] | None:
        ...
        if self.historical_data_cache:
            # Retrieve the next historical data point
            timestamp, data_point = self.historical_data_cache.pop(0)
